...
public class CustomerPanel extends Dialog implements MyCustomerPanel {
     ...
     *
     * @param isOn TRUE to turn on the highlight, otherwise, turn off the
     * highlight.
     */
     ...
     * CustomerPanel.
     *
     * @param active the active status of the DrinkSelectionBox; TRUE to
     * activate, FALSE to deactivate it.
     */
     ...
     *
     * @param active the active status of the Terminate Button; TRUE to
     * activate, FALSE to deactivate it.
     */
